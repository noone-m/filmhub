...
class GetPesonTVshowsUsecase extends BaseUseCase<List<Media>,int> {
  final PersonsRepository _basePersonsRepository;

  GetPesonTVshowsUsecase(this._basePersonsRepository);

  @override
  Future<Either<Failure,List<Media>>> call(int personId) async{
    return await _basePersonsRepository.getPersonTvShows(personId);
  }
} 
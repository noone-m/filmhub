...
import 'package:filmhub_app/movies/presentation/views/movie_details_view.dart';
import 'package:filmhub_app/movies/presentation/views/movies_view.dart';
import 'package:filmhub_app/movies/presentation/views/popular_movies_view.dart';
import 'package:filmhub_app/movies/presentation/views/top_rated_movies_view.dart';
import 'package:filmhub_app/search/presentation/views/search_view.dart';
import 'package:filmhub_app/tv_shows/presentation/views/popular_tv_shows_view.dart';
import 'package:filmhub_app/tv_shows/presentation/views/top_rated_tv_shows_view.dart';
import 'package:filmhub_app/tv_shows/presentation/views/tv_show_details_view.dart';
import 'package:filmhub_app/tv_shows/presentation/views/tv_shows_view.dart';

import 'package:filmhub_app/core/resources/app_routes.dart';
import 'package:filmhub_app/watchlist/presentation/views/watchlist_view.dart';
